...
Namespace FillEmptySpaceGridColumn
    ...
    Partial Public Class CarsDBDataSet
        ...
        Partial Public Class CarsDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddCarsRow(ByVal Trademark As String, ByVal Model As String, ByVal HP As Short, ByVal Liter As Double, ByVal Cyl As Byte, ByVal TransmissSpeedCount As Byte, ByVal TransmissAutomatic As String) As CarsRow
                Dim rowCarsRow As CarsRow = (DirectCast(Me.NewRow(), CarsRow))
                Dim columnValuesArray() As Object = { Nothing, Trademark, Model, HP, Liter, Cyl, TransmissSpeedCount, TransmissAutomatic}
    ...
    End Class
End Namespace
Namespace FillEmptySpaceGridColumn.CarsDBDataSetTableAdapters
    ...
    Partial Public Class CarsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Trademark`, `Model`, `HP`, `Liter`, `Cyl`, `TransmissSpeedCo" & "unt`, `TransmissAutomatic`) VALUES (?, ?, ?, ?, ?, ?, ?)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=""..\..\CarsDB.mdb"""
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Trademark, Model, HP, Liter, Cyl, TransmissSpeedCount, TransmissAutoma" & "tic FROM Cars"
        ...
        Public Overridable Function Insert(ByVal Trademark As String, ByVal Model As String, ByVal HP? As Short, ByVal Liter? As Double, ByVal Cyl? As Byte, ByVal TransmissSpeedCount? As Byte, ByVal TransmissAutomatic As String) As Integer
        ...
        Public Overridable Function Update(ByVal Trademark As String, ByVal Model As String, ByVal HP? As Short, ByVal Liter? As Double, ByVal Cyl? As Byte, ByVal TransmissSpeedCount? As Byte, ByVal TransmissAutomatic As String, ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_HP? As Short, ByVal Original_Liter? As Double, ByVal Original_Cyl? As Byte, ByVal Original_TransmissSpeedCount? As Byte, ByVal Original_TransmissAutomatic As String) As Integer
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(9).Value = (CStr(Original_Trademark))
            End If
            If (Original_Model Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(11).Value = (CStr(Original_Model))
            End If
            If (Original_HP.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(12).Value = (DirectCast(0, Object))
                Me.Adapter.UpdateCommand.Parameters(13).Value = (CShort(Original_HP.Value))
            Else
            ...
            If (Original_Liter.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(15).Value = (CDbl(Original_Liter.Value))
            Else
            ...
            If (Original_Cyl.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(17).Value = (CByte(Original_Cyl.Value))
            Else
            ...
            If (Original_TransmissSpeedCount.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(19).Value = (CByte(Original_TransmissSpeedCount.Value))
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(21).Value = (CStr(Original_TransmissAutomatic))
            End If
